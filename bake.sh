...
if [ "$registry" != "local" ]; then
  ...
  docker push "$registry/nginx:fancyindex-$nginx_mainline"
  docker push "$registry/nginx:fancyindex-alpine"
  docker push "$registry/nginx:fancyindex-alpine$alpine"
  docker push "$registry/nginx:fancyindex-alpine-mainline"
  docker push "$registry/nginx:fancyindex-alpine$alpine-mainline"
  docker push "$registry/nginx:fancyindex-alpine-$nginx_mainline"
  docker push "$registry/nginx:fancyindex-alpine$alpine-$nginx_mainline"
  docker push "$registry/nginx:fancyindex-stable"
  docker push "$registry/nginx:fancyindex-$nginx_stable"
  docker push "$registry/nginx:fancyindex-alpine-stable"
  docker push "$registry/nginx:fancyindex-alpine$alpine-stable"
  docker push "$registry/nginx:fancyindex-alpine-$nginx_stable"
  docker push "$registry/nginx:fancyindex-alpine$alpine-$nginx_stable"
fi
